...
func (q *smallQueue[V, P]) Size() int {
	return int(q.size)
}

func (q *smallQueue[V, P]) MaxSize() int {
...
func (q *smallQueue[V, P]) Peek(idx ...int) (value V, prio P) {
	i := q.start
...
func (q *smallQueue[V, P]) PopLast() (value V, prio P) {
	i := q.start + q.size - 1
